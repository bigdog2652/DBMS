...
select sections.id, courses.course_code, courses.title, professors.first_name, professors.last_name, meeting_days, start_time, end_time
...
where courses.title like "%Intro%" OR course_code like "intro" or professors.first_name like "intro" or professors.last_name like "intro";
